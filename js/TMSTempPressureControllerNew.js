...
app.controller('TMSTempPressureControllerNew', ['$scope', '$rootScope', '$state', 'APIServices',
	    ...
	    $scope.callTroubledVehiclesAPI = function(loadingImgStatus) {
            ...
            if($rootScope.tempPressureType == undefined || $rootScope.tempPressureType == ""){
              $rootScope.tempPressureType = 'All';
    		    ...
    		    APIServices.callGET_API($rootScope.HOST_TMS + 'api/tms/getTPMSVehDataNew?type='+$rootScope.tempPressureType, loadingImgStatus)
    		    .then(
