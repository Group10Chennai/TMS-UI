...
app.controller('TMSSysAdminController', ['$scope', '$rootScope', '$state', 'APIServices',
  ...
  $scope.searchRFID = function() {
    ...
    console.log('pageChanged_sensor() '+ from+ ' - '+$scope.sensorStatusFilter);
    ...
    console.log('sensorStatusChanged: '+$scope.sensorStatusFilter);
		$scope.limit_sensor = 10;
		$scope.startIndex_sensor = 0;
	...
	{
    console.log('getTMSAllSensors '+ status);
		try {
  ...
  $scope.totalItems_vehUserDetails = 0;
    ...
    console.log('pageChanged_vehUserDetails() ');
  ...
  var timer_vehUserDetails = false
    ...
    console.log('searchVehUserDetails() ');
