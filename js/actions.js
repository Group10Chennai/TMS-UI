...
/* EOF NEW OBJECT(GET SIZE OF ARRAY) */
  ...
  //Vehicles status
        //$('#OfflineVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(10000);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('OfflineVehilcesList', 'Offline Fleets', pids);
        //});
        //$('#CANDisconnectedVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(53);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('CANDisconnectedVehiclesList', 'CAN Disconnected Fleets', pids);
        //});
        //
        ////Different lamps status
        //$('#rsLampVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(39);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('RSLampVehiclesList', 'RS Lamp Fleets', pids);
        //});
        //$('#awlsVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(15);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('AWLSVehiclesList', 'AWLS Fleets', pids);
        //});
        //$('#milVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(14);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('MILVehilcesList', 'MIL Fleets', pids);
        //});
        //$('#dtcVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(10024);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('DTCVehiclesList', 'DTC Fleets', pids);
        //});
        //
        ////FDS Notifications
        //$('#fdsDeviceVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(10012);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('FDSDeviceVehiclesList', 'FDS Device Notifications - Fleets', pids);
        //});
        //$('#fdsHooterVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(10013);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('FDSHooterVehilcesList', 'FDS Hooter Notifications - Fleets', pids);
        //});
        //$('#fdsFaultyVehilcesListId').click(function(){
        //    var pids = new Array();
        //    pids.push(10014);
        //    document.getElementById("vehicleContainerId").innerHTML = '';
        //    getVehiclesList('FDSFaultyVehiclesList', 'FDS Faulty Notifications - Fleets', pids);
        //});
        //
        ...
        //                // alert("Dashboard service success");
        //                var jsonResponse = data;
        //                console.log(jsonResponse.results.length);
        //                $('#showVehiclesListModelId').modal('show');
        //                document.getElementById("headingId").innerHTML = heading;
        //                var resultDesign = '';
        //                if(jsonResponse.results.length == 0) {
        //                    var resultDesign = '<div>There are no fleet in this category.</div>'
        //                    document.getElementById("vehicleContainerId").innerHTML = resultDesign;
        //                }
        //                for(var i = 0; i < jsonResponse.results.length; i++) {
        //                    // console.log(jsonResponse.results[i]);
        //                    var vehicleDetails = jsonResponse.results[i];
        //                    var vehicleName = vehicleDetails.veh_name;
        //                    var vehicleId = vehicleDetails.veh_id;
        //                    var veh_updated_time = vehicleDetails.veh_updated_time;
        //                    var veh_param_details = vehicleDetails.VehParamValues;
        //                    
        //                    if(i == 0 || (i % 2) == 0) {
        //                        //even number
        //                        resultDesign =resultDesign + '<div class="row">';
        //                    }
        //                  
        //                    resultDesign =resultDesign + '<article class="card fl-left"><section class="date">'
        //                      +'<time datetime="23th feb"><span>'+vehicleName +'</span></time></section><section class="card-cont">';
        //                    
        //                    for(var j = 0; j < veh_param_details.length; j++) {
        //                        var param_id = veh_param_details[j].pid;
        //                        var param_device_date_time = veh_param_details[j].device_date_time;
        //                        var param_value = veh_param_details[j].value;
        //                        
        //                        resultDesign +='<div class="even-info"><i class="fa fa-map-marker"></i>'
        //                            +'<p>'+param_value+'</p></div>'
        //                            +'<div class="even-date"><i class="fa fa-calendar"></i><time><span>'
        //                            +param_device_date_time+'</span></time></div>';
        //                    }
        //                    resultDesign = resultDesign+'</section></article>';
        //                    if((i % 2) != 0) {
        //                        //even number
        //                        resultDesign = resultDesign+'</div>';
        //                    }
        //                }
        //                document.getElementById("vehicleContainerId").innerHTML = resultDesign;
        //            },
        //            error: function (e) {
        //                console.log("Error in Dashboard service call:"+e);
        //            }
        //        });
        //    } catch(e) {
        //        console.log(e);
